  ...
  return (
    <div className="container py-15 mt-20">
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="flex-1 md:flex-3/5 w-full flex bg-secondary-dark flex-col items-center justify-center  gap-8 p-4 sm:p-10 lg:p-15 border-b md:border-r border-white/10 rounded-xl">
